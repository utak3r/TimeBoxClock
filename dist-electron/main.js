...
var J = (e, t, r) => (Is(e, t, "read from private field"), r ? r.call(e) : t.get(e)), st = (e, t, r) => t.has(e) ? vi("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), ze = (e, t, r, n) => (Is(e, t, "write to private field"), n ? n.call(e, r) : t.set(e, r), r), ht = (e, t, r) => (Is(e, t, "access private method"), r);
import Xc, { ipcMain as wt, app as ur, BrowserWindow as Wc, nativeImage as md, Tray as pd, Menu as $d } from "electron";
...
const kt = Jc.homedir(), va = Jc.tmpdir(), { env: Er } = fe, wd = (e) => {
  ...
  const t = Er.APPDATA || ee.join(kt, "AppData", "Roaming"), r = Er.LOCALAPPDATA || ee.join(kt, "AppData", "Local");
  return {
  ...
  return {
    data: ee.join(Er.XDG_DATA_HOME || ee.join(kt, ".local", "share"), e),
    config: ee.join(Er.XDG_CONFIG_HOME || ee.join(kt, ".config"), e),
    cache: ee.join(Er.XDG_CACHE_HOME || ee.join(kt, ".cache"), e),
    // https://wiki.debian.org/XDGBaseDirectorySpecification#state
    log: ee.join(Er.XDG_STATE_HOME || ee.join(kt, ".local", "state"), e),
    temp: ee.join(va, t, e)
  };
};
...
const Et = (e, t) => {
  ...
  attempt: {
    /* ASYNC */
    chmod: Et(Se(Y.chmod), vn),
    chown: Et(Se(Y.chown), vn),
...
var Ee = {}, ds = function e(t, r) {
  ...
  return t !== t && r !== r;
}, _l = { exports: {} }, Ct = _l.exports = function(e, t, r) {
...
function qn(e, t, r, n, s, a, o, c, l, d) {
  if (n && typeof n == "object" && !Array.isArray(n)) {
    ...
    for (var u in n) {
      ...
      } else (u in Ct.keywords || e.allKeys && !(u in Ct.skipKeywords)) && qn(e, t, r, h, s + "/" + u, a, s, u, n);
    }
    r(n, s, a, o, c, l, d);
  }
}
...
const El = Ir, ji = ye, Ia = pt, Zn = ye, eh = us, xr = lt, As = Mt, U = Q, B = qe, th = Ee, $t = A, Hr = fn;
function rh(e) {
  if (Pl(e) && (Nl(e), Sl(e))) {
    ah(e);
    return;
...
const Xe = Q, Ph = hn, xt = qe, Ze = Ee, Di = A, Nh = et;
let fs = class {
  constructor(t) {
    var r;
...
(function(e) {
  ...
  function N(P) {
    var p, S, $, i, f, b, I, j, F, L, se, Fe, Lt, Ft, zt, Ut, qt, Kt, Gt, Ht, Bt, Xt, Wt, Jt, Yt;
    ...
    return {
      ...
      strictTuples: (Fe = (se = P.strictTuples) !== null && se !== void 0 ? se : Be) !== null && Fe !== void 0 ? Fe : "log",
...
const $m = Ar, Vi = re, De = Q, $r = qe, Li = ke, En = A, ym = {
  keyword: "$ref",
  schemaType: "string",
  code(e) {
...
const Sn = re, Je = Q, Sp = qe, Pn = A, Pp = {
...
const Tt = Q, Qi = A, j$ = qe, k$ = {
  ...
  code(e) {
    ...
    c instanceof Tt.Name ? t.if((0, Tt._)`${c} !== true`, () => t.forIn("key", n, (h) => t.if(d(c, h), () => l(h)))) : c !== !0 && t.forIn("key", n, (h) => c === void 0 ? l(h) : t.if(u(c, h), () => l(h))), a.props = !0, e.ok((0, Tt._)`${s} === ${j$.default.errors}`);
    function l(h) {
      if (r === !1) {
...
Vt.extendSubschemaData = R_;
function O_(e, { jtdDiscriminator: t, jtdMetadata: r, compositeRule: n, createErrors: s, allErrors: a }) {
  n !== void 0 && (e.compositeRule = n), s !== void 0 && (e.createErrors = s), a !== void 0 && (e.allErrors = a), e.jtdDiscriminator = t, e.jtdMetadata = r;
}
Vt.extendSubschemaMode = O_;
var be = {}, gu = { exports: {} }, Dt = gu.exports = function(e, t, r) {
  typeof t == "function" && (r = t, t = {}), r = t.cb || r;
  var n = typeof r == "function" ? r : r.pre || function() {
  }, s = r.post || function() {
  };
...
const bu = jr, oc = _e, jo = yt, ss = _e, U_ = _s, sn = dt, Fs = Vt, q = te, X = ft, q_ = be, _t = C, Xr = pn;
function K_(e) {
  if (Nu(e) && (Ru(e), Pu(e))) {
    B_(e);
    return;
...
var Lo = {}, Fo = {};
Object.defineProperty(Fo, "__esModule", { value: !0 });
const as = te, Ot = as.operators, os = {
...
const He = te, On = C, Tv = {
  ...
  code(e) {
    ...
    if ((0, On.alwaysValidSchema)(a, r)) {
      let g = (0, He._)`${u} >= ${o}`;
      c !== void 0 && (g = (0, He._)`${g} && ${u} <= ${c}`), e.pass(g);
      return;
    }
    a.items = !0;
    const h = t.name("valid");
    c === void 0 && o === 1 ? _(h, () => t.if(h, () => t.break())) : o === 0 ? (t.let(h, !0), c !== void 0 && t.if((0, He._)`${s}.length > 0`, E)) : (t.let(h, !1), E()), e.result(h, () => e.reset());
    function E() {
      const g = t.name("_valid"), y = t.let("count", 0);
      _(g, () => t.if(g, () => w(y)));
    }
    ...
    function w(g) {
      t.code((0, He._)`${g}++`), c === void 0 ? t.if((0, He._)`${g} >= ${o}`, () => t.assign(h, !0).break()) : (t.if((0, He._)`${g} > ${c}`, () => t.assign(h, !1).break()), o === 1 ? t.assign(h, !0) : t.if((0, He._)`${g} >= ${o}`, () => t.assign(h, !0)));
    }
  }
};
xo.default = jv;
...
const Qs = "aes-256-cbc", It = () => /* @__PURE__ */ Object.create(null), Gc = (e) => e !== void 0, Zs = (e, t) => {
...
}, jt = "__internal__", xs = `${jt}.migrations.version`;
var At, Qe, Ce, Ke, cr, lr, Or, ot, ge, xu, ed, td, rd, nd, sd, ad, od;
class JS {
  constructor(t = {}) {
    st(this, ge);
    Gr(this, "path");
    ...
    ze(this, Ce, r), ht(this, ge, ed).call(this, r), ht(this, ge, rd).call(this, r), ht(this, ge, nd).call(this, r), this.events = new EventTarget(), ze(this, Qe, r.encryptionKey), this.path = ht(this, ge, sd).call(this, r), ht(this, ge, ad).call(this, r), r.watch && this._watch();
  }
  get(t, r) {
  ...
  reset(...t) {
    for (const r of t)
      Gc(J(this, Ke)[r]) && this.set(r, J(this, Ke)[r]);
  }
  delete(t) {
    const { store: r } = this;
  ...
  clear() {
    ...
    for (const r of Object.keys(J(this, Ke)))
      Gc(J(this, Ke)[r]) && (Zs(r, J(this, Ke)[r]), J(this, Ce).accessPropertiesByDotNotation ? gn(t, r, J(this, Ke)[r]) : t[r] = J(this, Ke)[r]);
    this.store = t;
  }
  onDidChange(t, r) {
    if (typeof t != "string")
  ...
  get store() {
    ...
    try {
      ...
      return J(this, cr) || this._validate(s), Object.assign(It(), s);
    } catch (r) {
  ...
  set store(t) {
    if (this._ensureDirectory(), !js(t, jt))
      try {
        const r = Y.readFileSync(this.path, J(this, Qe) ? null : "utf8"), n = this._decryptData(r), s = this._deserialize(n);
        js(s, jt) && gn(t, jt, bi(s, jt));
      } catch {
      }
  ...
  */
  _closeWatcher() {
    J(this, lr) && (J(this, lr).close(), ze(this, lr, void 0)), J(this, Or) && (Y.unwatchFile(this.path), ze(this, Or, !1)), ze(this, ot, void 0);
  }
  _decryptData(t) {
    if (!J(this, Qe))
  ...
  _validate(t) {
    if (!J(this, At) || J(this, At).call(this, t) || !J(this, At).errors)
      return;
    const n = J(this, At).errors.map(({ instancePath: s, message: a = "" }) => `\`${s.slice(1)}\` ${a}`);
  ...
  _watch() {
    if (this._ensureDirectory(), Y.existsSync(this.path) || this._write(It()), fe.platform === "win32" || fe.platform === "darwin") {
      J(this, ot) ?? ze(this, ot, Sc(() => {
        this.events.dispatchEvent(new Event("change"));
      }, { wait: 100 }));
      const t = ee.dirname(this.path), r = ee.basename(this.path);
      ze(this, lr, Y.watch(t, { persistent: !1, encoding: "utf8" }, (n, s) => {
...
At = new WeakMap(), Qe = new WeakMap(), Ce = new WeakMap(), Ke = new WeakMap(), cr = new WeakMap(), lr = new WeakMap(), Or = new WeakMap(), ot = new WeakMap(), ge = new WeakSet(), xu = function(t) {
  const r = {
    configName: "config",
    fileExtension: "json",
  ...
  ze(this, At, n.compile(s)), ht(this, ge, td).call(this, t.schema);
}, td = function(t) {
...
const id = ee.dirname(yd(import.meta.url)), Le = new QS({
  defaults: {
    projects: [],
    jobs: []
  }
});
wt.on("log", (e, t) => console.log("Renderer/Preload:", t));
wt.handle("db:get-projects", () => (console.log("IPC: db:get-projects"), Le.get("projects")));
wt.handle("db:add-project", (e, t) => {
  console.log("IPC: db:add-project", t);
  const r = Le.get("projects");
  return Le.set("projects", [...r, t]), t;
});
wt.handle("db:delete-project", (e, t) => {
  console.log("IPC: db:delete-project", t);
  const r = Le.get("projects");
  Le.set("projects", r.filter((n) => n.id !== t));
});
wt.handle("db:update-project", (e, t) => {
  console.log("IPC: db:update-project", t);
  const r = Le.get("projects");
  return Le.set("projects", r.map((n) => n.id === t.id ? t : n)), t;
});
wt.handle("db:get-jobs", () => (console.log("IPC: db:get-jobs"), Le.get("jobs")));
wt.handle("db:add-job", (e, t) => {
  console.log("IPC: db:add-job", t);
  const r = Le.get("jobs");
  return Le.set("jobs", [...r, t]), t;
});
wt.handle("db:update-job", (e, t) => {
  console.log("IPC: db:update-job", t);
  const r = Le.get("jobs");
  return Le.set("jobs", r.map((n) => n.id === t.id ? t : n)), t;
});
wt.handle("db:delete-job", (e, t) => {
  console.log("IPC: db:delete-job", t);
  const r = Le.get("jobs");
  Le.set("jobs", r.filter((n) => n.id !== t));
});
